...
export const DataKanban = ({ data, onChange }: DataKanbanProps) => {
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            // Remove the tasks from the source column
            const sourceColumn = [...newTasks[sourceStatus]];
            const [movedTask] = sourceColumn.splice(source.index, 1);

            // If there is no moved task, return the previous state
            if(!movedTask) {
                console.error('No source column found at the source index')
                return prevTasks;
            }

            // Create new task object with updated status OR task moved within same status
            ...
            // Update positions for moved tasks in the destination column
            ...
            // If task moved between columns, update positions in source column
